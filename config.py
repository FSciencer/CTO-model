...
# Batch size of validation for a single GPU, could be overwritten by command line argument
...
def update_config(config, args):
    ...
    if args.batch_size_val:
        config.DATA.BATCH_SIZE_VAL = args.batch_size_val
    if args.img_size:
